...
/**
 * 对七牛云对象储存的操作接口
 * 七牛云开放的Java-API文档 https://developer.qiniu.com/kodo/sdk/1662/java-sdk-6
 * 0. 七牛云个人控制中心查看Access key 和 Secret Key
  */
@Slf4j
@RestController
...
public class QiNiuController {
    ...
    /**
     * 七牛云开放API接口：获取空间文件列表接口
     * 详细文档 https://developer.qiniu.com/kodo/sdk/1239/java#rs-list
     */
    @GetMapping("/list")
    public R list() {
        QiniuProperties qiniu = properties.getQiniu();
